...
// "cat" + "dog" = "catdog"
// Write a function that takes two strings and concatenates
...
map (fun x -> x + 1) [1;2;3] |> printfn "%A"  // => [2;3;4]

// -----------
// EXERCISE 5:
// Use the map and fold functions to find the sum of the sum of the 
